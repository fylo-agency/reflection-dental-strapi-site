...
export interface ApiAboutPageAboutPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Special about pages with dynamic content sections (Meet Doctors, Team, Core Values, etc.)';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Reflections Dental Care'>;
...
export interface ApiDoctorDoctor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    personalInfo: Schema.Attribute.RichText;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Dental office locations';
  ...
  attributes: {
    address: Schema.Attribute.Component<'location.address', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    hours: Schema.Attribute.Component<'location.business-hours', true>;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    template: Schema.Attribute.Enumeration<
      ['default', 'contact', 'about', 'homepage']
    > &
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Resource pages like dental savings plans, forms, galleries, etc.';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Dental services offered';
    displayName: 'Service';
    pluralName: 'services';
